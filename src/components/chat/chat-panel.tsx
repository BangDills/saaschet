      ...
      {hasMessages ? (
        <>
          <div ref={scrollRef} className="relative flex-1 overflow-y-auto">
            <div ref={messagesRef} className="mx-auto w-full max-w-3xl px-4 pb-24 pt-4 sm:px-6">
          ...
          <div ref={composerRef} className="relative z-10 shrink-0 bg-background px-4 py-3 shadow-[0_-1px_0_0_var(--border)]">
            {showScrollToLatest && (
              <button
                ...
                className="absolute -top-12 left-1/2 z-20 flex size-9 -translate-x-1/2 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-md transition-colors hover:bg-muted"
              >
